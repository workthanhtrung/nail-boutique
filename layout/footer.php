	...
	<footer>
		<div class="main-content" style="margin-top:30%;">
			<div class="left box">
				<h2>VỀ CHÚNG TÔI </h2>
				<div class="content">
					<p>Chúng tôi tạo ra website nay với mong muốn chia sẻ những kiến thức và kinh nghiệm thực tiễn mà chúng tôi đã có được. Website được bởi 3 thành viên và giảng viên của lớp C2010G</br>
						<i class="fas fa-user-tie"></i> Trần Văn Điệp </br>
			...
			<div class="center box">
				...
				<div class="content">
					...
					<div class="email">
						...
						<span class="text">ABC@aptechlearning.edu.vn</span>
					</div>
				</div>
			</div>
			<div class="right box">
				...
				<div class="content">
					<div class="content-ul">
						...
						<ul style="margin-left: 30px">
							...
							<a href=""style="margin: 40px"><li>Join Team</li></a>
						</ul>
					</div>	
				</div>
			</div>
